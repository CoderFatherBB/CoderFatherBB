    ...
    <section id="about" className="hero-lab relative flex min-h-[100svh] items-center overflow-hidden pt-28">
      ...
      <div className="container relative z-10 mx-auto px-6 pb-16 md:px-12 md:pb-24">
        <div className="grid items-center gap-14 lg:grid-cols-[1.12fr_0.88fr] lg:gap-20">
          ...
          >
              I&apos;m <strong className="text-[1.12em] font-extrabold text-blue-300">Bhavin Baldota</strong>, a Lead Software Engineer in GenAI/ML at <strong className="font-bold text-[#f15a24]">Persistent Systems</strong>—turning LLMs, RAG, vision, and multi-agent ideas into systems people can actually use.
            </motion.p>
